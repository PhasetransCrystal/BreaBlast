...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute> SKILL_INACTIVE_ENERGY =
            ATTRIBUTES.register("inactive_energy", () -> new RangedAttribute("attribute.name.skill.inactive_energy", 1024, 0, Integer.MAX_VALUE));

    public static final DeferredHolder<Attribute, Attribute> SKILL_ACTIVE_ENERGY =
            ATTRIBUTES.register("active_energy", () -> new RangedAttribute("attribute.name.skill.active_energy", 1024, 0, Integer.MAX_VALUE));

    public static final DeferredHolder<Attribute, Attribute> SKILL_MAX_CHARGE =
            ATTRIBUTES.register("max_charge", () -> new RangedAttribute("attribute.name.skill.max_charge", 1, 1, Integer.MAX_VALUE));

    public static final DeferredHolder<Attribute, Attribute> ENERGY =
            ATTRIBUTES.register("energy", () -> new RangedAttribute("attribute.name.skill.energy", 0, 0, Integer.MAX_VALUE));
}
